...
- (UIBarButtonItem *)barButtonItemForMenu:(Menu)menu
{
	...
	{
        //custom code from custom image on slider button
/*        UIImage *sliderbuttonImage = [UIImage imageNamed:@"menu-button.png"];
        int sliderButtonHeight = 70;
        int sliderButtonWidth = sliderbuttonImage.size.width;
        
        UIButton *sliderbutton = [UIButton buttonWithType:UIButtonTypeCustom];
        [sliderbutton setImage:sliderbuttonImage forState:UIControlStateNormal];
        sliderbutton.frame = CGRectMake(0, 0, sliderButtonWidth, sliderButtonHeight);
        [sliderbutton addTarget:self action:selector forControlEvents:UIControlEventTouchUpInside];
        UIView *sliderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, sliderButtonWidth, sliderButtonHeight)];
        sliderView.bounds = CGRectOffset(sliderView.bounds, -5, 0);
        [sliderView addSubview:sliderbutton];
        UIBarButtonItem *sliderBarItem = [[UIBarButtonItem alloc] initWithCustomView:sliderView];
